...
public class Menu extends javax.swing.JPanel {
    ...
    public void menuSetuser(ModelUser user){
     ...
     public void init(){
        ...
        if(user.getRole().equals("Admin")){
            listMenu1.addItem(new Model_Menu("8", "Add Code Game", Model_Menu.MenuType.MENU));
        }else{
            listMenu1.addItem(new Model_Menu("", " ", Model_Menu.MenuType.EMPTY));
        }
        if(user.getRole().equals("Admin")){
            listMenu1.addItem(new Model_Menu("8", "Add Coupon", Model_Menu.MenuType.MENU));
        }else{
            listMenu1.addItem(new Model_Menu("", " ", Model_Menu.MenuType.EMPTY));
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8-game-50.png"))); // NOI18N
        jLabel1.setText("Dgff.com");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(listMenu1, javax.swing.GroupLayout.PREFERRED_SIZE, 394, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    protected void paintChildren(Graphics g) {
        ...
        GradientPaint gp = new GradientPaint(0, 0, Color.decode("#2193b0"), 0, getHeight(), Color.decode("#6dd5ed"));
        g2.setPaint(gp);
